...
func main() {
	var (
		...
		stripManagedFields       = app.Flag("strip-managed-fields", "Strip metadata.managedFields from status.atProvider.manifest.").Default("false").Envar("STRIP_MANAGED_FIELDS").Bool()
