...
func Setup(mgr ctrl.Manager, o controller.Options, po pcontroller.Options) error {
	...
	if err := object.Setup(mgr, o, po.SanitizeSecrets, po.StripManagedFields, po.PollJitterPercentage, po.LegacyCSAFieldManagers); err != nil {
		return err
	}
...
func SetupGated(mgr ctrl.Manager, o controller.Options, po pcontroller.Options) error {
	...
	if err := object.SetupGated(mgr, o, po.SanitizeSecrets, po.StripManagedFields, po.PollJitterPercentage, po.LegacyCSAFieldManagers); err != nil {
		return err
	}
